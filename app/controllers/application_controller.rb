class ApplicationController < ActionController::Base
  ...
  def set_locale
    new_locale = params[:locale] || extract_locale_from_config || Rails.application.config.i18n.default_locale
    ...
    Rails.logger.info "I18n is [#{Rails.application.config.i18n.locale}], default_locale is [#{Rails.application.config.i18n.default_locale}]"
  end
